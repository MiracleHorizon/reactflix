...
import { MovieCreditsCategoriesHandler } from 'modules/movie/MovieCreditsCategoriesHandler'
import styles from './MovieTopCredits.module.scss'

export const MovieTopCredits = observer(() => {
  const { credits, contentLength } = useMemo(() => {
    return new MovieCreditsCategoriesHandler(MovieStore.credits.crew).topCredits
  }, [])
